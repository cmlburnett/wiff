...
def _main_info(args):
	...
	for i in w.channel:
		...
		vals.append( ("Digital Min", c.digitalminvalue) )
		vals.append( ("Digital Max", c.digitalmaxvalue) )
		vals.append( ("Analog Min", c.analogminvalue) )
		vals.append( ("Analog Max", c.analogmaxvalue) )
